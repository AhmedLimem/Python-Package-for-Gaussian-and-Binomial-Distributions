...
class Binomial(Distribution):
    ...
    #       Binomial distribution is defined by two variables: 
    #           p : the probability of getting a positive outcome
    #           n : the number of trials
    
    #       Calculate the mean and standard deviation with the following formula:
    #           mean = p * n
    ...
    def plot_bar_pdf(self):
        ...
        # calculate the x, y values to visualize
